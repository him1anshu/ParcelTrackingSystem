<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editDelivery.aspx.cs" Inherits="editDelivery" %>
          ...
          <nav class="admpNavbar">
            ...
            <section>
                ...
                <div id="admpMain">
                    ...
                    <div class="addHead">
                        <h1 class="display-4">EDIT DELIVERY</h1>
                        <div class="addCenter">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtTrckId" runat="server" Class="form-control" placeholder="Enter Track Id..." ValidationGroup="deliveryValidation" ReadOnly="True"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDelSrcBrId" runat="server" Class="form-control" placeholder="Enter Branch Id..." ValidationGroup="deliveryValidation" ReadOnly="True"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDelSrcBrName" runat="server" Class="form-control" placeholder="Enter Branch Name..." ValidationGroup="deliveryValidation" ReadOnly="True"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDelEmpMail" runat="server" Class="form-control" ReadOnly="true" ></asp:TextBox>
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtDelEmpMail" Display="Dynamic" ErrorMessage="Employee Mail Required" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                            </div>

                            <div class="form-group">
                                <label>Date Of Delivery</label>
                                <asp:TextBox ID="txtDelDateOfDel" runat="server" Class="form-control" ValidationGroup="deliveryValidation" ></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDelDateOfRec" runat="server"  Class="form-control" ValidationGroup="deliveryValidation"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDelDestBrId" runat="server" Class="form-control" placeholder="Enter Branch Id..." ValidationGroup="deliveryValidation" ReadOnly="true" ></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtDelDestBrName" runat="server" Class="form-control" placeholder="Enter Branch Name..." ValidationGroup="deliveryValidation" ReadOnly="true" ></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtExpDelDateOfDel" runat="server" Class="form-control" ValidationGroup="deliveryValidation"></asp:TextBox>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label>Status</label>
                                <asp:TextBox ID="txtDelStatus" runat="server" Class="form-control"  ValidationGroup="deliveryValidation" ReadOnly="true" ></asp:TextBox>
                            </div>

                            <!--Delivery Status-->

                            <div class="form-group">
                                <asp:Button ID="btnEdit" runat="server" class="btn btn-outline-info" Text="Edit" OnClick="btnEdit_Click"/>
                            </div>
