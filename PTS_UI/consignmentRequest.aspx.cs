...
public partial class consignmentRequest : System.Web.UI.Page

{
    ...
    protected void btnConsSubmit_Click(object sender, EventArgs e)
    {
        ...
        consignmentEntityObj.consSrcBranchId_ = txtSrcBrId.Text.Trim().ToUpper();
        ...
        consignmentEntityObj.consDestBranchId_ = txtDestBrId.Text.Trim().ToUpper();
        ...
        idIncrementCons++;
        idIncrementTrck++;
        consignmentEntityObj.consId_ = "CONSUSRID" + Convert.ToString(idIncrementCons);
        consignmentEntityObj.consTrackId_ = "TRCKUSRID" + Convert.ToString(idIncrementTrck);
